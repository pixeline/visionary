...
function initialiseReconaissance(data){
	...
	var stageWidth = 400, // 400
		...
		checkResult = function() {
	        ...
	        $("#test-2").find("[type=checkbox]").removeAttr("checked").attr("disabled","true").parent().removeClass("result-radio");
	        console.log( $("#test-2").find("input[value='"+cvd_type+"']") )
	        if(cvd_type == "succeed"){
	        	$("#test-2").find("input[value='succeed']").removeAttr("disabled").attr("checked","true").parent().addClass("result-radio");
	        } else {
	        	$("#test-2").find("input[value='"+cvd_type+"']").removeAttr("disabled").attr("checked","true").parent().addClass("result-radio");
	        	$("#test-2").find("input[value='fail']").removeAttr("disabled").attr("checked","true").parent().addClass("result-radio");
	        }
...
function initialiseClassement(data){
	...
	var stageWidth = 400, // 400
		...
		checkResult = function() {
	        ...
	        $("#test-1").find("[type=checkbox]").removeAttr("checked").attr("disabled","true").parent().removeClass("result-radio");

	        if(cvd_type == "succeed"){
	        	$("#test-1").find("input[value='succeed']").removeAttr("disabled").attr("checked","true").parent().addClass("result-radio");
	        } else {
	        	$("#test-1").find("input[value='"+cvd_type+"']").removeAttr("disabled").attr("checked","true").parent().addClass("result-radio");
	        	$("#test-1").find("input[value='fail']").removeAttr("disabled").attr("checked","true").parent().addClass("result-radio");
	        }
